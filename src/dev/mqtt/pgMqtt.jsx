...
function PublishSection(props) {
  const [topics , setTopics ] = useState(() => props.payloads.map((p) => props.topic));
        ...
        return (
          <div key={i} className='payload-container'>
            <header className='payload-header'>
              ...
              <input className='payload-topic' value={topics[i]} onChange={(e) => handleTopicChange(e, i)}/>
              <button
                onClick={handlePublish}
                className='payload-publish'>publish</button>
            </header>
...
function SubscribeSection(props) {
  return (
    <SubscribeSectionStyle className='subscribe-section'>
