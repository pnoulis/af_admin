...
src/app/route_registration_team/store.jsx:      state.active.players = state.active.players.map((player) => {
src/app/route_registration_team/store.jsx:      // state.active?.players.forEach((player) => {
src/app/route_registration_team/route_players/register_wristband/RegisterWristband.jsx:        roster={state.active?.players}
src/app/route_registration_team/events.jsx:        state.active?.players.find(
